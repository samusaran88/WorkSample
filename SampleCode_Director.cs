...
public class SampleCode_Director : MiniGameDirectorBase
{
    [Serializable]
        ...
        while (count < maxCount && breakPoint < maxCount * 100)
        {
            ...
            while (breakPoint < maxCount * 100)
            {
                ...
                if (sheepCount == 0)
                {
                    ...
                    SampleCode_Sheep sheep = sheepObj.GetComponent<SampleCode_Sheep>();
    ...
    void SpawnRandom(bool isBlackGoat)
    {
        ...
        int count = 0;
        SampleCode_Sheep selected = null;
        foreach (SampleCode_Sheep sheep in listSheep)
        {
    ...
    void SpawnRandom(int maxCount)
    {
        ...
        int count = 0;
        SampleCode_Sheep selectedSheep = null;
        foreach (SampleCode_Sheep sheep in listSheep)
        {
    ...
    public void AddPlayerScore(NetGameState.PlayerId playerId, int score)
    {
        ...
        SampleCode_Player castedPlayer = player as SampleCode_Player;
