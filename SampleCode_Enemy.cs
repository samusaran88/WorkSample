...
public class ShepherdDogSheep : NetworkBehaviour
{
    ...
    [SerializeField] ShepherdDogEventTrigger runAwayEvent;
    [SerializeField] ShepherdDogEventTrigger jumpEvent;
    ...
    private void OnCollisionStay(Collision collision)
    {
        ...
        {
            ShepherdDogSheep s = collision.gameObject.GetComponent<ShepherdDogSheep>();
            ...
            case eSheepState.isRun:
                {
                    ...
                    foreach (Collider c in Physics.OverlapSphere(transform.position, seeRadius))
                    {
                        ...
                        {
                            ShepherdDogSheep s = c.transform.parent.GetComponent<ShepherdDogSheep>();
